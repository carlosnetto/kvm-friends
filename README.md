...
| `<vm-name>.qcow2` | A VM's disk (256 GB virtual by default, thin-provisioned — grows with use). VMs get fixed RAM (no ballooning — real memory, 16 GB by default) and fixed vCPUs (1, 4, or 8, 8 by default), both chosen at creation time. |
